...
<div class="hero_ligne_haute">
  ...
  <img class="image_parcourir" name="image_parcourir" src="images/jeu/hua/hero/detail/bouton_parcourir.png" >
  </a>

  <a class="lien_ajouter" href="index.php?page=jeu&espace=hua&onglet=hero&type=creation">
  <img class="image_ajouter" name="image_ajouter" src="images/jeu/hua/hero/detail/bouton_ajouter.png" >
  </a>

  <a class="lien_supprimer" href="index.php?page=jeu&espace=hua&onglet=hero&type=suppression">
  <img class="image_supprimer" name="image_supprimer" src="images/jeu/hua/hero/detail/bouton_supprimer.png" >
  </a>

  <div class="hero_nom">Nom du h&eacute;ro</div>

  <a class="lien_retour" href="index.php?page=jeu&espace=hua&onglet=hero&type=liste">
  <img class="image_retour" name="image_retour" src="images/jeu/hua/hero/detail/fermer.png" >
  </a>
</div>
...
<div class="hero_ligne_basse">
  ...
  <div class="hero_ligne_basse_centre">
    ...
    <img class="image_equiper" name="image_equiper" src="images/jeu/hua/hero/detail/bouton_equiper.png" >
    </a>

    <a class="lien_niveau_suivant" href="index.php?page=jeu&espace=hua&onglet=hero&type=niveau_suivant">
    <img class="image_niveau_suivant" name="image_niveau_suivant" src="images/jeu/hua/hero/detail/bouton_niveau_suivant.png" >
    </a>

    <img class="image_icone_mana" name="image_icone_mana" src="images/jeu/hua/hero/detail/icone_mana.png" >

    <div class="hero_mana">120000</div>

    <a class="lien_vendre" href="index.php?page=jeu&espace=hua&onglet=hero&type=vendre">
    <img class="image_vendre" name="image_vendre" src="images/jeu/hua/hero/detail/bouton_vendre.png" >
    </a>
